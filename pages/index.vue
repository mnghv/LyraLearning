...
<template>
  <article>
    <h1 class="mb-8"> Lyra Learning</h1>
    <p class="mb-10">
      ...
      <NuxtLink to="/about" class="text-purple-600 hover:text-purple-700">about page</NuxtLink>.
    </p>
    ...
    <div class="grid sm:grid-cols-2 gap-6">
      ...
      <TransitionGroup enter-active-class="duration-200 ease-in" enter-from-class="transform opacity-0"
        enter-to-class="opacity-100" leave-active-class="duration-200 ease-in" leave-from-class="transform opacity-100"
